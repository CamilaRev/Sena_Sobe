                            ...
                            <form  ROLE="FORM" METHOD="POST" ENCTYPE="MULTIPART/FORM-DATA" ACTION="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" class="form-control" id="precio" name="precio" placeholder="Precio del producto" min="1" pattern="^[0-9]+" required>
                                        </div>
                                    

                                        <div class="mb-3">
                                            <input type="number" class="form-control" id="stock" name="stock" placeholder="stock del producto" min="1" pattern="^[0-9]+" required>
