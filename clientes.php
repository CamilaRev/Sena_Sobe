        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $clientes = 'SELECT * FROM usuario WHERE u_tipo != 1 ORDER BY u_id DESC;';
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="cedula" name="cedula"  value="<?php echo!empty($dato['u_identificacion']) ? $dato['u_identificacion'] : ''; ?>" min="1" pattern="^[0-9]+" disabled>
                                </div>
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="celular" name="celular"  value="<?php echo!empty($dato['u_celular']) ? $dato['u_celular'] : ''; ?>" min="1" pattern="^[0-9]+" disabled>
                                </div>
